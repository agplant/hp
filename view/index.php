<?php
require_once '../php/history/define.php';
require_once '../php/base/AgString.php';
require_once '../php/history/' . DB_PATH . 'HistorysDao.php';
require_once '../php/history/' . DB_PATH . 'ContentsDao.php';
...
<body>
    ...
    <header>  
      <div class="header-line">
        ...
        <div class="logo">一戦場梨園</div>
          <!-- <a href="inquiry.php" class="inquiry-button ">お問い合わせ</a> -->
          <!-- btn-square-shadow -->
        <!-- </div> -->
    ...
    <div class="content-relative">
      ...
      <div class="content">
        <div class="tab-content" id="tab0-content">
          <div class="signboard">
            <div id="slideshow">
              <img src="../img/background1.jpg" alt="画像1">
              <img src="../img/background2.jpg" alt="画像2">
              <img src="../img/fly.png" alt="画像2">
            </div>
            <!-- <div class="signboard-back"></div>
            <div class="signboard-main"></div> -->
          ...
          <div class="history">
            ...
            <div class="detail">
              ...
              <?php } ?>
              <!-- <ul>
                <li>2019/8/1 幸水の販売を開始しました</li>
                <li>2019/4/1 ホームページ開設</li>
              </ul> -->
            </div>
          </div>
        </div>
        <div class="tab-content" id="tab1-content">
          ...
          <div class="about">
            <div>
              <img src="../img/farm-owner.png" class="farm-owner">
              <div>一戦場梨園主の近影</div>
            </div>
            <div>
              <h2>当園について</h2>
              <p>一戦場梨園は宮城県蔵王町に存在する梨園です。当園では4種類の梨を育てています。</p>
              <h2>梨について</h2>
        ...
        <div class="tab-content" id="tab3-content">
          ...
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3138.8713626893705!2d140.64868244921246!3d38.11992699990271!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x5f8a39aebdad3fbd%3A0xfc256962de621911!2z44CSOTg5LTA4MjEg5a6u5Z-O55yM5YiI55Sw6YOh6JS1546L55S65YaG55Sw5LiA5oim5aC077yR4oiS77yR!5e0!3m2!1sja!2sjp!4v1551967216973"
            width="auto" height="150" style="border:0"></iframe>
        </div>
  ...
  <script src="../lib/node_modules/animejs/lib/anime.min.js"></script>
